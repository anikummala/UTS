						...
						<nav class="navbar navbar-default" role="navigation">
							<div class="container-fluid">
								...
								<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
									...
									<a class="navbar-brand">My Biodata</a>
								</div>
							...
							<table class="table table-hover" id="example">
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td><img src="<?=base_url()?>assets/uploads/<?=$key->foto?> " width="150" height="150"></td>
										<td>											
											...
											<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" type="button" class="btn btn-danger" onClick="JavaScript: return  pconfirm('Anda Yakin Hapus Data ?')">Delete </a>

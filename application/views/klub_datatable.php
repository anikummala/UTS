		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<nav class="navbar navbar-default" role="navigation">
							<div class="container-fluid">
								...
								<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
									...
									<a class="navbar-brand" href="#">UTS Framework</a>
								</div>
						
								<!-- Collect the nav links, forms, and other content for toggling -->
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
										<li class="active"><a href="<?php echo site_url('Klub') ?>">Data Club</a></li>
									</ul>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1>Daftar Klub</h1>	
						<br>	
						<a href="<?php echo site_url('klub/create') ?>" type="button" class="btn btn-danger">Create Data Pegawai</a>	
						<br><br><br>
							...
							<table class="table table-hover" id="example">
								...
								<?php foreach ($klub_list as $key) { ?>
									<tr>
										...
										<td><img src="<?=base_url()?>assets/uploads/<?=$key->logo?> " width="150" height="150"></td>
										<td>											

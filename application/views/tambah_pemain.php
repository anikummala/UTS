				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php echo form_open_multipart('pemain/create'); ?>
								...
								<div class="form-group">
									...
									<input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" placeholder="Input field" >

								</div>
								
								<div class="form-group">
									<label for="">Klub</label>
									<input type="text" class="form-control" id="tanggal_lahir" name="tanggal_lahir" placeholder="Input field" >
